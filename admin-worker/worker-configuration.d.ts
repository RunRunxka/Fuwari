/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=admin-worker/wrangler.jsonc --env-interface=WorkerBindings admin-worker/worker-configuration.d.ts` (hash: 0fd23828694f2d4e5076695660f08f91)
// Runtime types generated with workerd@1.20260710.1 2026-07-17
interface __BaseEnv_WorkerBindings {
	MEDIA_BUCKET: R2Bucket;
	FRONTEND_ORIGIN: "https://runrunxka.xyz";
	GITHUB_OWNER: "RunRunxka";
	GITHUB_REPO: "Fuwari";
	GITHUB_BASE_BRANCH: "main";
	MEDIA_PUBLIC_BASE_URL: "https://fuwari-studio-api.runrunxka.workers.dev/media";
